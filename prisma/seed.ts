...
const businessDefs: BusinessDef[] = [
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1611432579699-484f7990b127?w=200&h=200&fit=crop&crop=face',
    businessName: 'Chez Esther Traiteur',
    coverImage: 'https://images.unsplash.com/photo-1604329760661-e71dc83f8f26?w=1200&h=400&fit=crop',
    ...
    products: [
      {
        ...
        price: 15,
        type: 'PHYSICAL',
        images: ['https://images.unsplash.com/photo-1604329760661-e71dc83f8f26?w=600&h=800&fit=crop'],
      },
      {
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1562159278-1253a58da141?w=1200&h=400&fit=crop',
    category: 'Beaute',
    description:
    ...
    products: [
      {
        ...
        price: 45,
        type: 'SERVICE',
        images: ['https://images.unsplash.com/photo-1562159278-1253a58da141?w=600&h=800&fit=crop'],
      },
      {
        ...
        price: 35,
        type: 'SERVICE',
        images: ['https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=600&h=800&fit=crop'],
      },
      {
        ...
        price: 150,
        type: 'PHYSICAL',
        images: ['https://images.unsplash.com/photo-1580618672591-eb180b1a973f?w=600&h=800&fit=crop'],
      },
    ],
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        price: 120,
        type: 'SERVICE',
        images: ['https://images.unsplash.com/photo-1478146059778-26028b07395a?w=600&h=800&fit=crop'],
      },
      {
        ...
        price: 200,
        type: 'SERVICE',
        images: ['https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600&h=800&fit=crop'],
      },
    ],
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        price: 55,
        type: 'PHYSICAL',
        images: ['https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=600&h=800&fit=crop'],
      },
      {
  ...
  const eventDefs = [
    {
      ...
      coverImage: 'https://images.unsplash.com/photo-1529070538774-1f9c32f5e4e2?w=1200&h=400&fit=crop',
