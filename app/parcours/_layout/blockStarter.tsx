...
const BlockStarter = () => {
  return (
    <div className="block-intro lg:py-[100px] py-[50px]">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-12 lg:gap-6 gap-4">
          <div className="col-span-12 lg:col-span-6">
            <div className="card-img relative w-full lg:w-[90%] min-h-[350px] md:min-h-[500px] h-full rounded-2xl overflow-hidden">
          ...
          <div className="col-span-12 lg:col-span-6">
            ...
            <h4 className="text-2xl lg:text-4xl font-medium text-black mb-4 lg:mb-6">
