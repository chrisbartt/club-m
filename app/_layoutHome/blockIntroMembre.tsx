        ...
        <div className="grid grid-cols-12 gap-4 w-full">
          ...
          <div className="col-span-12 lg:col-span-6">
            <div className="flex flex-col justify-center h-full 2xl:pr-24 lg:pr-14">
              ...
              <h4 className="text-2xl lg:text-[44px] 2xl:text-[48px] leading-[1.2] font-semibold text-[#151516] mb-1 lg:mb-1 tracking-[-0.02em]">
              Découvre les femmes qui font vivre le Club M
              </h4>
              <h4 className="text-xl lg:text-[30px] italic leading-[1.2] font-medium text-[#151516] mb-3 lg:mb-4 tracking-[-0.02em]">
              Consultantes, Commerçantes, Créatrices, Expertes proposent des produits, des services, des collaborations..
...
Ce sont des entrepreneures engagées qui développent des projets concrets.
                ...
                >
                  <Link href="/annuaires">
                  Explore l’annuaire des membres</Link>
                </Button>
              </div>
            </div>
          </div>
