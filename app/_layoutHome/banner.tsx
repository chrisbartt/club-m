        ...
        <div className="container mt-auto px-4">
          <div className="grid grid-cols-12 gap-5 lg:gap-10 items-end">
            <div className="col-span-12 lg:col-span-8">
              <h1 className="text-4xl lg:text-[64px] 2xl:text-[76px] font-medium text-white mb-3 tracking-[-0.02em]">
              Tu n’es plus seule. Tu avances avec méthode.

              </h1>
              <p className="text-white lg:text-xl mb-6 lg:mb-6 max-w-[500px]">
              Le Club M t’aide à le transformer en entreprise structurée, rentable et crédible.
              </p>
