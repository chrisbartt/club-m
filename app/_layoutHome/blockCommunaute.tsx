...
const BlockCommunaute = () => {
  ...
  return (
    <div className="block-difference bg-[#151516] relative z-20 py-[50px] lg:py-[0px]">
      ...
      <div className="container-full px-4 md:px-0">
        <div className="grid grid-cols-12 lg:gap-6 gap-3">
          ...
          <div className="col-span-12 md:col-span-6">
            <div className="h-full lg:p-[50px] 2xl:p-[100px] lg:py-[100px] flex items-center">
              <div>
                ...
                On transforme des rencontres en opportunités.
                </h2>
                <h4 className="text-2xl lg:text-[38px] italic leading-[1.2] font-medium text-white mb-2 lg:mb-4 tracking-[-0.02em]">
                On se retrouve, on partage et on construit.
                </h4>
                <p className="text-white/80 text-base md:text-lg w-full md:w-[550px] leading-relaxed mb-2">
                Nos événements réunissent des femmes entrepreneures ambitieuses prêtes à développer leur business avec du concret : stratégies, connexions qualifiées, collaborations réelles
                </p>
                <p className="text-white/80 text-base md:text-lg w-full md:w-[550px] leading-relaxed mb-4 md:mb-6">
                Ce ne sont pas que des évènements.
Ce sont des espaces où :

                </p>
                <ul className="flex flex-wrap gap-3 mb-4 md:mb-6">
                  <li className="flex gap-2 items-center text-white text-base md:text-lg leading-relaxed py-2 px-2 bg-[#ffff]/10 backdrop-blur-sm rounded-full">
                ...
                <h6 className="text-[#ffffff] mb-6 lg:text-[24px] text-[16px] font-medium md:mb-6">
