  ...
  const steps = [
    {
      ...
      description:
        "Présente ton idée de business en détail via notre formulaire guidé.",
      duration: "1 semaine",
      icon: Clock,
    },
    {
      ...
      description:
        "Notre équipe analyse ton projet et sa cohérence avec ta vie.",
    ...
    },
    {
      ...
      description:
        "Un échange en visio pour discuter de l'analyse avec Maurelle.",
    ...
    },
    {
      ...
      title: "Plan d'action",
      description:
        "Tu reçois ta restitution avec les prochaines étapes recommandées.",
