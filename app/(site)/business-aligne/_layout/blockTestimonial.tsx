...
import { TESTIMONIALS } from "@/app/(site)/data/testimonialsData";
...
const BlockTestimonial = () => {
  ...
  return (
    <div className="block-difference lg:py-[100px] py-[50px] relative z-10 bg-[#f8f8f8]">
      <div className="container px-4 mx-auto relative z-10">
        <div className="relative">
          ...
          <div className="text-center lg:max-w-2xl mx-auto mb-10 lg:mb-14">
            ...
            Elle avait une idée floue. <br /> Elle est repartie avec un business plan financé. 
            </h2>
          </div>
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 mt-10 lg:mt-12">
              <CarouselPrevious
                className="static translate-y-0 w-12 h-12 rounded-full bg-[#091626]  text-white hover:bg-[#091626]/80 hover:text-white cursor-pointer border-0"
