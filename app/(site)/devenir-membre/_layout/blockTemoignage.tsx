...
const TEMOIGNAGES = [
  ...
  },
  {
    ...
    description:
      "Femme entrepreneuse",
    link: "https://www.instagram.com/reel/DTVmUo7gtk_/",
    type: "Reel",
    date: "22 Fév 2026",
  },
  {
    ...
    title: "Vanessa Tshamala",
    description:
      "Femme entrepreneuse",
    link: "https://www.instagram.com/reel/DTLTwFMAryw/",
    type: "Reel",
    date: "18 Fév 2026",
  },
];
                  ...
                  <div className="card h-full overflow-hidden">
                    ...
                    >
                      ...
                      <div className="absolute bottom-3 left-0 w-full p-5">
                        ...
                        <p className="text-[#ffffff] lg:text-[16px] text-[14px]">{t.description}</p>
                      </div>
                    </Link>
                  </div>
                </div>
