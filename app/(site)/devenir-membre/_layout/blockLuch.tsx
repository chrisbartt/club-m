...
const BlockLuch = () => {
  return (
    <div className="block-intro lg:py-[100px] py-[50px] bg-white hidden">
          ...
          <div className="col-span-12 lg:col-span-6">
            <div className="lg:pl-26">
              ...
              <h4 className="text-2xl lg:text-[48px] leading-[1.2] font-semibold text-[#091626] mb-2 lg:mb-4 tracking-[-0.02em]">
                Une idée ne suffit pas. Elle doit être structurée.
              </h4>
              <div>
                <p className="text-muted-foreground md:mb-8 lg:text-[18px] text-[16px]">
                  Business Aligné : le cadre qui transforme les idées en
                  projets. <br />
                  Une idée ne suffit pas. Elle doit être structurée.
                </p>
