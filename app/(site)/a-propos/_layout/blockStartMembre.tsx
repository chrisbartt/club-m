    ...
    <div className="block-start-membre lg:py-[100px] py-[50px] relative z-10 bg-[#581621]">
      ...
      <div className="container px-4 mx-auto">
        <div className="text-center lg:max-w-3xl mx-auto">
          ...
          Rejoindre le Club M, ce n’est pas seulement rejoindre une communauté.
          </h2>
          <p className="mb-6 lg:text-[18px] text-[16px] text-white max-w-xl mx-auto">
          C&apos;est choisir, de ne plus avancer seule, de structurer ton business, de créer de vraies opportunités et de t’entourer de femmes qui avancent comme toi.
