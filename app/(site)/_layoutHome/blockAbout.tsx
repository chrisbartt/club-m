...
const BlockAbout = () => {
  return (
    <div className="block-intro lg:py-[100px] lg:pt-[50px] py-[50px] bg-[#ffff]">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-12 gap-4 w-full">
          ...
          <div className="card-img w-full relative mx-auto 2xl:w-[80%] lg:w-[90%] md:min-h-[500px] min-h-[350px] h-full z-10">
              ...
              {/* Badge overlay */}
              <div className="absolute bottom-6 left-6 bg-[#151516]/30 backdrop-blur-sm p-4 rounded-xl flex flex-col gap-3 z-20">
          ...
          <div className="col-span-12 lg:col-span-6">
            <div className="flex flex-col justify-center h-full 2xl:pr-28 lg:pr-14">
              ...
              <div className="lg:pr-24">
                ...
                <h6 className="text-[#091626] mb-6 text-xl md:text-xl lg:text-2xl font-medium">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="/a-propos">Découvre la communauté</Link>
                </Button>
              </div>
            </div>
          </div>
