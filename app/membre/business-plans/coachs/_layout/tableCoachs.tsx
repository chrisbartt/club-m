...
const mockCoachs: Coach[] = [
    ...
    },
    {
        ...
        avatarColor: "bg-bgSidebar dark:bg-bgGray",
        specialite: "finance",
        bpAssignes: 10,
        disponibilite: "disponible",
        note: 4.7,
                ...
                <div className="col-span-12 lg:col-span-8 flex items-center justify-end gap-3">
                    ...
                    <Popover open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                        <PopoverTrigger asChild>
                            <Button
                                variant="outline"
                                className="h-10 px-4 border-colorBorder dark:border-colorBorder text-colorTitle hover:bg-bgGray gap-2 shadow-none cursor-pointer dark:bg-transparent"
                            >
                                <Filter size={16} />
                    ...
                    {/* Download Button */}
                    <Button
                        className="h-10 px-4 bg-bgSidebar text-white hover:bg-bgSidebar/90 gap-2 shadow-none dark:bg-bgGray"
                    >
                        <Download size={16} />
