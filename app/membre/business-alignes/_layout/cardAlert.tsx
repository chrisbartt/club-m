...
import { AlertCircle, ArrowRight, Lightbulb, MessageCircle, UserX, Zap } from "lucide-react";
...
const AlertRow = ({ type, icon, iconBgColor, title, description, secondaryInfo, button }: AlertItem) => {
    ...
    const buttonStyles = {
        ...
        outline: "bg-white border border-colorBorder text-colorTitle hover:bg-bgGray",
    };
    ...
    return (
        <div className="w-full card cardShadow bg-bgCard rounded-xl overflow-hidden py-5 px-6">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <Link
                    href="/business-plans/accompagnement"
