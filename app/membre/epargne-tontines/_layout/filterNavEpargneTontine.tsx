...
const navLinks = [
    {
        href: "/epargne-tontines",
        label: "Dashboard",
        icon: LayoutDashboard,
    },
    {
        href: "/epargne-tontines/tontines",
        label: "Tontines",
        icon: PiggyBank,
    },
    {
        href: "/epargne-tontines/membres",
        label: "Membres",
        icon: Users,
    },
    {
        href: "/epargne-tontines/demandes",
        label: "Demandes",
        icon: UserPlus,
    },
    {
        href: "/epargne-tontines/alertes",
        label: "Alertes",
        icon: AlertTriangle,
    },
    {
        href: "/epargne-tontines/notifications",
        label: "Notifications",
        icon: Bell,
    },
    {
        href: "/epargne-tontines/donnees-bancaires",
        label: "Données bancaires",
        icon: Banknote,
    },
    {
        href: "/epargne-tontines/exports-rapports",
...
const FilterNavEpargneTontine = () => {
    ...
    const isActive = (href: string) => {
        if (href === "/epargne-tontines") {
            return pathname === "/epargne-tontines";
        }
