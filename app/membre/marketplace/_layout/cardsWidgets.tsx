    ...
    return (
        <div className="bg-bgCard rounded-xl p-4 flex flex-col gap-3 cardShadow h-full">
            <div className="flex flex-col gap-4">
                ...
                {/* Value */}
                <div>
                    <p className="text-[32px] font-bold text-colorTitle leading-none mb-4">{value}</p>
                    {/* Label & Subtitle */}
                    <div>
        ...
        <div className="bg-primaryColor rounded-xl p-4 flex flex-col gap-3 cardShadow h-full relative z-10">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="col-span-12">
                    {/* Value */}
                    <div>
                        <p className="text-[32px] font-bold text-white leading-none mb-3">{value}</p>
                    </div>
    ...
    return (
        <div className="cards-widgets">
            ...
            <div className="grid grid-cols-12 gap-3 lg:gap-4">
                <div className="col-span-12 lg:col-span-3 gap-3 lg:gap-4">
                    <div className="grid grid-cols-12 gap-3 lg:gap-4 h-full">
                        <div className="col-span-12">
                            <FinanceCard
                                ...
                                details={[
                                    { icon: <Wallet size={14} />, label: "En séquestre", value: "$4,230" },
                                    { icon: <RefreshCw size={14} />, label: "Commissions Club M", value: "$2,485" },
                                    { icon: <Calendar size={14} />, label: "Paiements bloqués", value: "$850" },
                                ]}
                            />
                        </div>
                    </div>
