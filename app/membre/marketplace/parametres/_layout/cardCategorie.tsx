...
const CardCategorie = () => {
    ...
    return (
        <div className="w-full card cardShadow bg-bgCard rounded-xl overflow-hidden h-full flex flex-col">
            ...
            <div className="flex-1 flex flex-col gap-3 py-6 px-6">
                ...
                <div className="flex justify-end pt-4">
                    <Button
                        ...
                        className="h-11 px-6 bg-primaryColor  text-white hover:bg-primaryColor/90 hover:text-white rounded-lg font-medium shadow-none cursor-pointer gap-2"
                    >
                        <Plus size={18} />
