...
const FilterDashboard = () => {
    ...
    return (
        <div className="filter-dashboard flex flex-wrap items-center gap-3 py-[12px] bg-bgCard lg:px-4 px-3 2xl:px-6 border-t border-colorBorder cardShadow sticky top-[73px] z-50">
            {/* Label Période */}
