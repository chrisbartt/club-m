...
const navLinks = [
    ...
    {
        href: "/admin/business-plans/dossiers",
        label: "Dossiers",
        icon: Folder,
    },
    {
        href: "/admin/business-plans/membres",
        label: "Membres",
        icon: Users,
    },
    {
        href: "/admin/business-plans/coachs",
        label: "Coachs",
        icon: GraduationCap,
    },
    {
        href: "/admin/business-plans/alertes",
        label: "Alertes",
        icon: AlertTriangle,
    },
    {
        href: "/admin/business-plans/statistiques",
        label: "Statistiques",
        icon: BarChart3,
    },
    {
        href: "/admin/business-plans/parametres",
        label: "Paramètres",
        icon: Settings,
    },
...
const FilterNavBusinnessPlan = () => {
    ...
    const isActive = (href: string) => {
        if (href === "/admin/business-plans") {
            return pathname === "/admin/business-plans";
        }
