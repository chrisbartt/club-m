    ...
    return (
        <div className="w-full card cardShadow bg-bgCard rounded-xl overflow-hidden py-5 px-6">
            ...
            <div className="mb-6">
                ...
                <p className="text-[13px] text-colorMuted mt-0.5">Business plans par statut</p>
            </div>
            ...
            {/* Summary cards */}
            <div className="grid grid-cols-2 gap-3 mt-6 pt-4 border-t border-colorBorder">
