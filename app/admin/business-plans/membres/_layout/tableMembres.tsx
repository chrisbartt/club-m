                ...
                <div className="col-span-12 lg:col-span-8 flex items-center justify-end gap-3">
                    ...
                    <div className="relative w-full max-w-[250px]">
                        ...
                        <Input
                            ...
                            className="pl-9 h-10 bg-white border-colorBorder dark:bg-transparent text-[13px] placeholder:text-colorMuted shadow-none focus-visible:ring-0 focus-visible:ring-offset-0"
                        />
                    </div>
                    ...
                    <Popover open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                        <PopoverTrigger asChild>
                            <Button
                                variant="outline"
                                className="h-10 px-4 border-colorBorder dark:bg-transparent dark:border-colorBorder text-colorTitle hover:bg-bgGray gap-2 shadow-none cursor-pointer"
                            >
                                <Filter size={16} />
                    ...
                    {/* Download Button */}
                    <Button
                        className="h-10 px-4 bg-bgSidebar text-white hover:bg-bgSidebar/90 gap-2 shadow-none cursor-pointer dark:bg-bgGray"
                    >
                        <Download size={16} />
                        ...
                        {mockMembres.map((membre) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-4">
                                    <Link
                                        href={`/admin/business-plans/dossiers/${membre.id}`}
                                ...
                                {/* Actions */}
                                <td className="px-4 py-4 text-center">
                                    <ActionButton action={membre.action} onShowDetail={() => openDrawer("ShowDetail")} />
                                </td>
                            </tr>
                        ))}
                    </tbody>
