...
const ProgressBar = ({ value }: { value: number }) => {
    ...
    return (
        <div className="flex items-center gap-3">
            <div className="w-[100px] h-[6px] bg-bgGray rounded-full overflow-hidden">
                <div
        ...
        <div className="card cardTable cardShadow w-full bg-bgCard rounded-xl overflow-hidden h-full">
            ...
            <div className="grid grid-cols-12 items-center justify-between gap-4 px-6 py-4">
                ...
                <div className="col-span-12 lg:col-span-8 flex items-center justify-end gap-3">
                    ...
                    {/* Download Button */}
                    <Button
                        className="h-10 px-4 bg-bgSidebar text-white hover:bg-bgSidebar/90 dark:bg-bgGray gap-2 shadow-none cursor-pointer"
                    >
                        <Download size={16} />
                        ...
                        {mockDossiers.map((dossier) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-4">
                                    <Link
                                        href={`/admin/business-plans/dossiers/${dossier.id}`}
