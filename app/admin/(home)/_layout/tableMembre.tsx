...
const StatutBadge = ({ statut }: { statut: StatutType }) => {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[12px] font-medium ${className}`}
    >
      {icon}
      {label}
    </span>
...
const TableMembre = () => {
  return (
    <div className="card cardTable cardShadow w-full bg-bgCard rounded-xl overflow-hidden h-full">
      {/* Header */}
      <div className="flex flex-col lg:flex-row lg:items-center justify-between md:gap-4 gap-2 p-4 lg:px-6 lg:py-5 border-b border-colorBorder">
        {/* Title */}
