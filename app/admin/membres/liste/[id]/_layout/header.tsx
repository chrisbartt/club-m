...
const Header = () => {
    ...
    return (
        <div className="card cardShadow w-full bg-bgSidebar rounded-xl overflow-hidden py-6 md:px-8 px-6 relative z-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center md:gap-6 gap-3">
                {/* Avatar */}
                <div className="md:w-[100px] w-[80px] md:h-[100px] h-[80px] rounded-full bg-[#d4a853] flex items-center justify-center text-bgSidebar text-[28px] font-bold flex-shrink-0">
                    {memberData.initials}
                </div>
