        ...
        <AppContainer>
            <div className="content-page py-3 pt-0 lg:py-4 flex-grow lg:pt-0">
                ...
                <div className="container-fluid w-full px-4 lg:px-4 2xl:px-6">
                    <div className="grid grid-cols-12 gap-3 lg:gap-4 mt-4 lg:mt-6">
                        <div className="col-span-12">
                            <h1 className="md:text-[24px] text-[20px] font-semibold text-colorTitle">Vue d&apos;ensemble des membres</h1>
