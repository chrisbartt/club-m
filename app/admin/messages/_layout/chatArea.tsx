...
const ChatArea = () => {
    ...
    const messages: Message[] = [
        {
            id: "1",
            text: "Bonjour, j'ai une question sur mon Business Plan. Comment dois-je structurer la partie financière ?",
            timestamp: "14:30",
            isOwn: false,
            sender: "Marie Kabila",
        },
        {
            id: "2",
            text: "Bonjour Marie ! Je vais t'aider avec ça. Pour la partie financière, commence par identifier tes sources de revenus...",
            timestamp: "14:32",
            isOwn: true,
            sender: "Admin",
        },
        {
            id: "3",
            text: "D'accord, merci. Et pour les dépenses, dois-je inclure tous les coûts même ceux qui ne sont pas certains ?",
            timestamp: "14:35",
            isOwn: false,
            sender: "Marie Kabila",
        },
        {
            id: "4",
            text: "Oui, il est important d'être exhaustif. Tu peux créer différentes catégories : fixes, variables, et prévisionnelles.",
            timestamp: "14:37",
            isOwn: true,
            sender: "Admin",
        },
            ...
            <div className="bg-bgCard border-b border-colorBorder p-4 py-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="w-[40px] h-[40px] rounded-full bg-bgSidebar dark:bg-bgGray flex items-center justify-center text-white text-[14px] font-semibold">
                            MK
                        </div>
                        <div>
                            <h3 className="text-[16px] font-semibold text-colorTitle">Marie Kabila</h3>
                            <p className="text-[12px] text-colorMuted flex items-center gap-2">
                                <span className="w-2 h-2 bg-[#25a04f] rounded-full"></span>
                                En ligne
                                <span className="text-[11px] px-2 py-0.5 rounded bg-[#e68b3c]/10 text-[#e68b3c]">
                                    Business
                                </span>
                            </p>
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                <DropdownMenuItem>Voir le profil membre</DropdownMenuItem>
                                <DropdownMenuItem>Voir le Business Plan</DropdownMenuItem>
