...
import TableCommandes from './tableCommandes';
import ShowCommande from '@/components/features/marketplace/showCommande/showCommande';
const Content = () => {
    return (
        <>
                ...
                <div className="container-fluid w-full px-4 lg:px-4 2xl:px-6">
                    <div className="grid grid-cols-12 gap-3 lg:gap-4 lg:mt-6 items-center">
                        <div className="col-span-12 lg:col-span-8">
                            ...
                            Suivi complet du cycle de vie des transactions
                            </p>
                        </div>
