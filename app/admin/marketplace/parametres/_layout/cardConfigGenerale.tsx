...
const CardConfigGenerale = () => {
    ...
    return (
        <div className="w-full card cardShadow bg-bgCard rounded-xl overflow-hidden">
            ...
            {/* Form */}
            <div className="flex flex-col gap-6 md:py-6 py-5 md:px-6 px-5">
                <div className="flex flex-col gap-2">
                    <label
                        htmlFor="taux-commission"
                        className="text-[14px] font-medium text-colorTitle"
                    >
                        Taux de commission (%)
                    </label>
                    <Input
                ...
                <div className="flex md:justify-end md:pt-4">
                    <Button
                        onClick={handleSave}
                        className="h-11 w-full md:auto px-8 bg-primaryColor rounded-lg text-white hover:bg-primaryColor/90 font-semibold shadow-none cursor-pointer gap-2"
                    >
