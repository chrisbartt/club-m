...
const CardConfigBp = () => {
    ...
    return (
        <div className="w-full card cardShadow bg-bgCard rounded-xl overflow-hidden ">
            {/* Header */}
            <div className="flex items-center gap-2 py-5 md:px-6 px-5 border-b border-colorBorder">
                <h3 className="text-[16px] font-semibold text-colorTitle">Configuration générale</h3>
            </div>

            {/* Form */}
            <div className="flex flex-col gap-6 py-6 md:px-6 px-5">
                ...
                <div className="flex justify-end md:pt-4 pt-3">
                    <Button
                        onClick={handleSave}
                        className="h-11 px-8 w-full md:w-auto bg-primaryColor text-white hover:bg-primaryColor/90 font-semibold shadow-none"
                    >
                        Enregistrer les modifications
                    </Button>
                </div>
