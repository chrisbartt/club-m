...
// Configuration des liens de navigation (business-alignes)
const navLinks = [
    {
    ...
    {
        href: "/admin/business-alignes/membres",
        label: "Membres",
        icon: Users,
    },
    {
        href: "/admin/business-alignes/coachs",
        label: "Coachs",
        icon: GraduationCap,
    },
    {
    ...
    {
        href: "/admin/business-alignes/statistiques",
        label: "Statistiques",
        icon: BarChart3,
    },
    {
        href: "/admin/business-alignes/parametres",
        label: "Paramètres",
        icon: Settings,
    },
...
const FilterNavBusinnessPlan = () => {
    ...
    const isActive = (href: string) => {
        if (href === "/admin/business-alignes") {
            return pathname === "/admin/business-alignes";
        }
        return pathname.startsWith(href);
    };

    return (
        <div className="filter-nav-membre flex items-center gap-2 py-[12px] bg-bgCard lg:px-4 px-3 2xl:px-6 border-t border-colorBorder sticky lg:top-[73px] top-[63] z-50">
            <button
                type="button"
                onClick={() => scroll("left")}
