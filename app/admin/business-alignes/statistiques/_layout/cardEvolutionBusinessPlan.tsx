        ...
        <div className="w-full card cardShadow bg-bgCard rounded-xl overflow-hidden py-5 md:px-6 px-5 h-full">
            ...
            <div className="flex md:items-center justify-between mb-6 flex-col md:flex-row gap-2">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[12px] text-colorMuted">BA Créés</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-sm bg-[#25a04f]" />
                        <span className="text-[12px] text-colorMuted">BA Finalisés</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-8 mt-6 pt-4 border-t border-colorBorder">
                <div className="text-center">
                    ...
                    <p className="text-[12px] text-colorMuted">Total BA créés</p>
                </div>
                <div className="text-center">
                    <p className="text-[24px] font-bold text-[#25a04f]">32</p>
                    <p className="text-[12px] text-colorMuted">Total BA finalisés</p>
                </div>
                <div className="text-center">
