                ...
                <div className="grid grid-cols-12 md:gap-4 gap-2 mb-8">
                  ...
                  <div className="flex flex-col col-span-12 lg:col-span-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm lg:text-base text-muted-foreground">
                      Mise en place de ton plan d&apos;action.
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-col col-span-12 lg:col-span-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm lg:text-base text-muted-foreground">
                      Suivi de ton projet et de ton avancement.
                      </p>
                    </div>
                  </div>
